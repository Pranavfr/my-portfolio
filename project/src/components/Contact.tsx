...
const Contact = () => {
  ...
  const quickStats = [
    ...
    { icon: Award, label: 'Client Rating', value: '5.0★', color: 'yellow' },
    { icon: MessageCircle, label: 'Projects Delivered', value: '50+', color: 'green' },
    { icon: MapPin, label: 'Availability', value: '24/7', color: 'purple' },
  ];
