    ...
    <section id="contact" className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-900">
      ...
      >
          ...
          {quickStats.map((stat) => {
            ...
            return (
              ...
              >
                ...
                <div className={`text-xl font-bold text-${stat.color}-400 mb-1`}>
                  {stat.value}
                </div>
        ...
        <motion.div 
          ...
          variants={containerVariants}
        >
          <motion.div className="bg-gray-800 rounded-xl border border-gray-700 p-8" variants={cardVariants}>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-3 bg-gray-700 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-cyan-400 transition-colors duration-300"
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  rows={6}
                  className="w-full px-4 py-3 bg-gray-700 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-cyan-400 transition-colors duration-300 resize-none"
              ...
              <motion.button
                type="submit"
                className="w-full px-8 py-4 bg-gradient-to-r from-cyan-500 to-blue-500 text-white rounded-lg font-semibold transition-transform duration-300 hover:scale-105 flex items-center justify-center gap-3"
          ...
          <motion.div className="space-y-6" variants={containerVariants}>
            ...
            {contactInfo.map((info) => {
              ...
              return (
                <motion.a
                  ...
                  className="block p-6 bg-gray-800 rounded-xl border border-gray-700 hover:border-gray-600 transition-colors duration-300"
                  variants={cardVariants}
            ...
            <motion.div 
              className="p-6 bg-gradient-to-r from-cyan-500/10 to-blue-500/10 rounded-xl border border-cyan-500/20"
              variants={cardVariants}
            >
              <div className="flex items-center gap-4 mb-4">
                ...
                <h4 className="text-xl font-bold text-cyan-400">Currently Available</h4>
              </div>
