  ...
  return (
    <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-800">
      ...
      >
        ...
        <motion.div 
          className="relative bg-gray-900 rounded-xl border border-gray-700 p-8 min-h-[600px] overflow-hidden"
          variants={containerVariants}
        >
          {/* SVG for connections */}
            ...
            return (
              ...
              >
                <div className={`relative group`}>
                  {/* Node */}
                  <div className={`w-16 h-16 rounded-full bg-gradient-to-r from-${node.color}-500 to-${node.color}-600 flex items-center justify-center shadow-lg border-2 border-white/20 hover:border-white/40 transition-all duration-300`}>
                  ...
                  {/* Tooltip */}
                  <motion.div
                    className={`absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-3 py-2 bg-gray-800 text-white text-sm rounded-lg border border-gray-600 shadow-lg whitespace-nowrap ${
        ...
        {/* Legend */}
        <motion.div 
          className="mt-8 grid grid-cols-2 sm:grid-cols-4 gap-4 max-w-4xl mx-auto"
          variants={containerVariants}
        >
          {[
